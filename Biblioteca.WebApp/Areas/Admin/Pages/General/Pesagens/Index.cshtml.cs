...
namespace IFL.WebApp.Areas.Admin.Pages.General.Pesagens
{
    public class IndexModel : PagerAndFilterPageModel
    {
        ...
        public IList<Pesagem> Pesagens { get; set; } = default!;
