...
namespace IFL.WebApp.Areas.Admin.Pages.General.Modalidades
{
    ...
    {
        protected readonly IModalidadeRepository _repository;
        public IndexModel(IModalidadeRepository repository)
        {
            _repository = repository;
        }

        public IList<Modalidade> Modalidades { get; set; } = default!;
